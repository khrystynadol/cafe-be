...
def upgrade() -> None:
    ...
    op.create_table('archive_person',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    sa.Column('role', sa.Enum('client', 'manager', name='personstatus'), nullable=False),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    op.create_table('archive_custom',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('price', sa.Float(), nullable=False),
    sa.Column('time', sa.DateTime(), nullable=False),
    sa.Column('status', sa.Enum('registered', 'processed', 'accepted', 'prepared', 'delivered', 'done', 'cancelled', name='customstatus'), nullable=False),
    sa.Column('address_id', sa.Integer(), nullable=True),
    sa.Column('user_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['address_id'], ['address.id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['archive_person.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
...
def downgrade() -> None:
    ...
    op.drop_table('menu_picture')
    op.drop_table('ingredient')
    op.drop_table('custom')
    op.drop_table('archive_custom')
    op.drop_table('product')
    op.drop_table('person')
    op.drop_table('menu')
    op.drop_table('archive_person')
