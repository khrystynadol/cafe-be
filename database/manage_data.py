...
with app.app_context():
      ...
      menu1 = Menu(name="Late", price=75, availability=1, demand=0)
      menu2 = Menu(name="Cupcake", price=55, availability=1, demand=0)
      menu3 = Menu(name="Cappuccino", price=70, availability=1, demand=0)
      menu4 = Menu(name="Kakao", price=65, availability=1, demand=0)
      menu5 = Menu(name="Tea", price=65, availability=1, demand=0)
      ...
      ingredient1 = Ingredient(weight=250, percent=30, menu_id=menu1.id, product_id=product2.id)
      ingredient2 = Ingredient(weight=30, percent=1, menu_id=menu1.id, product_id=product1.id)
      ingredient3 = Ingredient(weight=3, percent=15, menu_id=menu1.id, product_id=product7.id)
      ingredient4 = Ingredient(weight=15, percent=30, menu_id=menu3.id, product_id=product1.id)
      ingredient5 = Ingredient(weight=200, percent=15, menu_id=menu3.id, product_id=product2.id)
      ingredient6 = Ingredient(weight=50, percent=30, menu_id=menu4.id, product_id=product8.id)
      ingredient7 = Ingredient(weight=200, percent=15, menu_id=menu4.id, product_id=product2.id)
      ingredient8 = Ingredient(weight=30, percent=15, menu_id=menu2.id, product_id=product4.id)
      ingredient9 = Ingredient(weight=30, percent=15, menu_id=menu2.id, product_id=product5.id)
      ingredient10 = Ingredient(weight=20, percent=30, menu_id=menu2.id, product_id=product9.id)
      ingredient11 = Ingredient(weight=30, percent=15, menu_id=menu2.id, product_id=product2.id)
      ingredient12 = Ingredient(weight=20, percent=30, menu_id=menu2.id, product_id=product10.id)
      ingredient13 = Ingredient(weight=1, percent=5, menu_id=menu2.id, product_id=product11.id)
