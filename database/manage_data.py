...
with app.app_context():
    person1 = Person(name="Khrystyna", surname="Dolynska", phone="0962250511",
                     email="hrystyna@gmail.com", password="12345", role=PersonStatus.manager.value)
    person2 = Person(name="Ivan", surname="Ivanov", phone="0934864659",
                     email="user2@gmail.com", password="12345", role=PersonStatus.client.value)
    person3 = Person(name="Kate", surname="Lover", phone="0685222554",
                     email="user3@gmail.com", password="12345", role=PersonStatus.client.value)
    ...
    custom1 = Custom(price=2550, time='2022-11-10 15:32:11',
                     address_id=address1.id, user_id=person2.id)
